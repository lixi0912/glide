 ...
 */
public class RequestManager implements LifecycleListener, LifecycleObserver, ModelTypes<RequestBuilder<Drawable>> {
    ...
    @Synthetic
    final android.arch.lifecycle.Lifecycle lifecycle;
    ...
    private final Runnable addSelfToLifecycle = new Runnable() {
        @Override
        public void run() {
            lifecycle.addObserver(RequestManager.this);
        }
    };
    ...
    public RequestManager(
            @NonNull Glide glide, @NonNull android.arch.lifecycle.Lifecycle lifecycle,
    ...
    RequestManager(
        ...
        lifecycle.addObserver(connectivityMonitor);
    ...
    public void onDestroy() {
        ...
        lifecycle.removeObserver(connectivityMonitor);
