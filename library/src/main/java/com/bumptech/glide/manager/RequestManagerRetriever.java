...
public class RequestManagerRetriever  {
            ...
            synchronized (this) {
                if (applicationManager == null) {
                    ...
                    applicationManager =
                            factory.build(
                                    glide,
                                    APPLICATION_LIFE_OWNER.getLifecycle(),
    ...
    private RequestManager of(LifecycleOwner owner, Context context, ViewModelProvider provider) {
        RequestManagerHolder current = provider.get(RequestManagerHolder.class);
        ...
        if (null == requestManager) {
            ...
            requestManager =
                    factory.build(
                            glide, owner.getLifecycle(), current.getRequestManagerTreeNode(), context);
    ...
    public RequestManager get(@NonNull FragmentActivity activity) {
        if (Util.isOnBackgroundThread()) {
            ...
            return of(activity, activity, ViewModelProviders.of(activity));
        }
    }
    ...
    public RequestManager get(@NonNull Fragment fragment) {
        ...
        if (Util.isOnBackgroundThread()) {
            ...
            return of(fragment, fragment.getContext(), ViewModelProviders.of(fragment));
        }
    }
    ...
    private static final AppLifeOwner APPLICATION_LIFE_OWNER = new AppLifeOwner();

    private static final class AppLifeOwner implements LifecycleOwner {
